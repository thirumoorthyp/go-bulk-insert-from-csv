...
So the huge performance difference is because of go-sqlite3 cgo package. Later found that an existing issue (https://github.com/mattn/go-sqlite3/issues/1145)
